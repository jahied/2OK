...
# https://www.facebook.com/https://Tor.Batar.420
...
try:
    ...
    if os.path.isfile('.../index.js'):
 	...
 	os.system('#')	os.system('cd && npm install')
...
\033[0;94m [!]\033[0;91mTOOL NAME :\033[0;92m𝐁𝐃/𝐈𝐍𝐃𝐈𝐀 
...
def tech_abm():
    ...
    if username =="B-H-T":
        ...
        if passwordss =="HACKERS":
            ...
            print ("\033[1;97m[+]\033[1;92m Username : B-H-T\033[1;92m (Correct)")

            print ("\033[1;97m[+]\033[1;92m Password : HACKERS\033[1;92m (Correct)")
	    ...
	    os.system('xdg-open https://m.facebook.com/Tor.Batar.420')
